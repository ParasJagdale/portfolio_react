export const projects = [
  ...
  },
  {
    ...
    description:
      "A platform to upload and share images securely, built with Django and Bootstrap.",
  ...
  },
  {
    ...
    description:
      "A responsive weather app fetching real-time weather data via OpenWeather API.",
